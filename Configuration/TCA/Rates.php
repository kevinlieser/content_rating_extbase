...
$TCA['tx_contentrating_rates'] = array(
	'ctrl' => $TCA['tx_contentrating_rates']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, rate_url, rate_pid, rate_getvars, rate_ip, rate_value',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, rate_url, rate_pid, rate_getvars, rate_ip, rate_value, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_contentrating_rates',
				'foreign_table_where' => 'AND tx_contentrating_rates.pid=###CURRENT_PID### AND tx_contentrating_rates.sys_language_uid IN (-1,0)',
			),
		),
